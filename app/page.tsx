  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <section className="container mx-auto max-w-6xl px-6 py-16">
        ...
        {/* Title — full width */}
        <h1 style={{ fontFamily: "'Modern Antiqua', serif", color: 'var(--text)', fontSize: 'clamp(3rem, 8vw, 6.5rem)', lineHeight: 1.0, fontWeight: 900, marginBottom: '2.5rem' }}>
          HALLOWED<br />HOP SOCIETY
        </h1>

        {/* Content row: text left, mug right */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            {isOctober && beer ? (
              <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', padding: '2rem', width: '100%', borderRadius: '16px' }}>
              ...
              <img
                ...
                style={{ width: '100%', maxWidth: '560px', height: 'auto', opacity: 0.9 }}
              />
            )}
          </div>
        </div>
