  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <section className="container mx-auto max-w-6xl px-6 py-16" style={{ overflow: 'hidden' }}>
        ...
        {/* Mug: float right with plain img so text wraps naturally */}
        {!isOctober && (
          // eslint-disable-next-line @next/next/no-img-element
          <img
            src="/mughhs.webp"
            alt="Hallowed Hop Society"
            style={{ float: 'right', width: '52%', maxWidth: '660px', minWidth: '300px', height: 'auto', marginLeft: '3rem', marginBottom: '1rem', opacity: 0.9 }}
          />
        )}
        {isOctober && beer && (
